<%@ Page Language="C#" MasterPageFile="~/Master/Managers.master" AutoEventWireup="true" CodeFile="DeclinedSecurity.aspx.cs" Inherits="Managers.Managers_DeclinedDeclinedSecurity" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <script language="javascript">
        document.getElementById("dsecurity").className = "active";
    </script>
    <h3>Orders sent back from Security</h3>
            ...
            <div class="gridBorder" style="height: 335px; width: 1000px;">
                <asp:GridView ID="GridEntries" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "WaiveSecurity.aspx?ID=" + Eval("ID") %>' Text="ACTION" ForeColor="Blue" runat="server"></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="ImmCorrAction_B" HeaderText="REASON" ControlStyle-Width="400px" ItemStyle-Width="400px" ReadOnly="true"
                                        SortExpression="ImmCorrAction_B"/>
