<%@ Page Language="C#" MasterPageFile="~/Master/Managers.master" AutoEventWireup="true" CodeFile="WaiveKRA.aspx.cs" Inherits="Managers.Managers_WaiveKRA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2>Safety-Load clearance form</h2>
            <h3 style="color: Red;">
            ...
            <p id="ParaResult" runat="server">
                <asp:FormView ID="FormView1Ai" onitemupdating="FormView1Ai_ItemUpdating" onitemupdated="FormView1Ai_ItemUpdated" DataKeyNames="QueueID" DefaultMode="Edit" DataSourceID="SqlSecuritySource" runat="server">
                    <EditItemTemplate>
                        ...
                        <p>
                            Inspected on: <asp:Label ID="LabelTime" runat="server" ForeColor="Red" Text='<%#Eval("SavedTime_C") %>' Font-Underline="true"></asp:Label>
                        </p>
                        ...
                        <table rules="all" border="solid" style="border: 2px solid #000000; width: 1000px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="Leaking_Loading_36" AutoPostBack="true" Enabled="false" Checked='<%# Eval("Leaking_Loading_36") == DBNull.Value ? false : Eval("Leaking_Loading_36") %>' runat="server"/>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="BioCode" AutoPostBack="true" Enabled="false" Checked='<%# Eval("BioCode") == DBNull.Value ? false : Eval("BioCode") %>' runat="server"/>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="ProperSealing_40" AutoPostBack="true" Enabled="false" Checked='<%# Eval("ProperSealing_40") == DBNull.Value ? false : Eval("ProperSealing_40") %>' runat="server"/>
                                </td>
                                <td>
                                    <asp:CheckBox ID="CheckBox4" AutoPostBack="true" Enabled="false" runat="server"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="ProductDestination" Enabled="false" AutoPostBack="true" Checked='<%# Eval("ProductDestination") == DBNull.Value ? false : Eval("ProductDestination") %>' runat="server"/>
                                </td>
                                <td>
                                    <asp:CheckBox ID="CheckBox3" AutoPostBack="true" Enabled="false" runat="server"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="switchEngaged" AutoPostBack="true" Enabled="false" Checked='<%# Eval("switchEngaged") == DBNull.Value ? false : Eval("switchEngaged") %>' runat="server"/>
                                </td>
                                <td>
                                    <asp:CheckBox ID="CheckBox5" AutoPostBack="true" Enabled="false" runat="server"/>
                        ...
                        <asp:Panel ID="CommentPanel" Visible="false" runat="server">
                            Comments<br/>
                            <asp:TextBox ID="ImmCorrectiveTxt" Text='<%# Bind("CorrectiveAction") %>' ValidationGroup="Comment" Enabled="false" Width="500px" TextMode="MultiLine" runat="server"></asp:TextBox><br/>
                        ...
                        <p>
                            <asp:Button ID="SaveBtn" CssClass="btn" ValidationGroup="Comment" CommandName="Update" runat="server" Visible="false" Text="SAVE"/><asp:Button ID="ApproveBtn" CssClass="btn" runat="server" Text="WAIVE TRUCK" onclick="ApproveBtn_Click"/>&nbsp;&nbsp;<asp:Button ID="GoBack" CssClass="btn" runat="server" Text="BACK"
            ...
            <asp:SqlDataSource ID="SqlSecuritySource" runat="server"
                               ...
                               UpdateCommand="UPDATE SafetySecurity_C SET SavedTime_C = @SavedTime_C, SavedBy_C = @SavedBy_C, Passed = @Passed FROM SafetySecurity_C INNER JOIN NewQueue ON SafetySecurity_C.QueueID = NewQueue.QueueID WHERE (SafetySecurity_C.QueueID = @QueueID)">
                <SelectParameters>
