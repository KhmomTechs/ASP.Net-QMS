...
namespace Reports
{
    public partial class Reports_Approval : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Approval.aspx?date=" + dt);
        }
        ...
        private void GetReport()
        {
            ...
            var selectRejected = "{CustomerCare.CustCareApproval} = True AND {NewQueue.SetDate} =  [CDATETIME(" + day +
                                 ")]";

            var reportdocument = new ReportDocument();
            reportdocument.Load(Server.MapPath("../Rpts-Crystal/Approvals.rpt"));
