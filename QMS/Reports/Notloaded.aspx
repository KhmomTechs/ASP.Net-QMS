<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="Notloaded.aspx.cs" Inherits="Reports.Reports_Notloaded" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        document.getElementById("Notloaded").className = "active";

        $(function() {
            $("#datepicker").datepicker();
        });
    </script>
    <h3>Trucks Not Loaded</h3>(Trucks that were not loaded on a particular day)
