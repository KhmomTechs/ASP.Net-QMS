<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="Flagged.aspx.cs" Inherits="Reports.OLD.Reports_Flagged" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        ...
        document.getElementById("flagged").className = "active";
    ...
    <h3>UNAUTHORIZED</h3>(Trucks that have been flagged)
