<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="Ranges.aspx.cs" Inherits="Reports.OLD.Reports_Ranges" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        document.getElementById("range").className = "active";

        $(function() {
            $("#datepicker").datepicker();
        });
    </script>
    <h3>Truck times</h3>(Break down of time taken at each stage for each truck that has been cleared)
