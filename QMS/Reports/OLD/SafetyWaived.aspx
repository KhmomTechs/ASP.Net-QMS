<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="SafetyWaived.aspx.cs" Inherits="Reports.OLD.Reports_SafetyWaived" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h3>Safety check</h3>(Waived by Depot manager from Safety inspection)
        ...
        <tr>
            <td style="text-align: left; vertical-align: text-top; width: 920px;">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="FailedReport.rpt">
                    </Report>
