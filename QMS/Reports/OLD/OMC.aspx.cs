...
{
    public partial class Reports_OMC : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Request.QueryString.Count > 0)
                {
                    ...
                    var selectCleared = "{NewQueue.Finished} = True AND {NewQueue.EnterTime} = '" + day + "'";
                    ...
                    reportdocument.Load(Server.MapPath("../Rpts-Crystal/OMC.rpt"));
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("OMC.aspx?date=" + dt);
        }
