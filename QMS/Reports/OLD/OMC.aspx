<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="OMC.aspx.cs" Inherits="Reports.OLD.Reports_OMC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        ...
        document.getElementById("omc").className = "active";
    ...
    <h3>OMC clearance</h3>(Trucks that have passed Security clearance)
        ...
        <tr>
            <td style="text-align: left; vertical-align: text-top; width: 920px;">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="OmcClearance.rpt">
                    </Report>
