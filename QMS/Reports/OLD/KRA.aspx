<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="KRA.aspx.cs" Inherits="Reports.OLD.Reports_KRA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h3>Load clearance</h3>(Waived by Depot manager from Safety/Load clearance)
        ...
        <tr>
            <td style="text-align: left; vertical-align: text-top; width: 920px;">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="FailedKRAReport.rpt">
                    </Report>
