<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="Reports.OLD.Reports_Approval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        document.getElementById("approval").className = "active";
    ...
    <h3>Approval</h3>(Users who approved trucks to the next stage in there dept)
