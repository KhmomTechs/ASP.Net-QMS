<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="Suspended.aspx.cs" Inherits="Reports.OLD.Reports_Suspended" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        document.getElementById("suspended").className = "active";

        $(function() {
            $("#datepicker").datepicker();
        });
    </script>
    <h3>Suspended</h3>(Trucks that are suspended)
