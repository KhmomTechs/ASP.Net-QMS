<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="CurrentOpen.aspx.cs" Inherits="Reports.OLD.Reports_CurrentOpen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h3>Current open orders</h3>(Trucks that have been Approved at Customer care)
        ...
        <tr>
            <td style="text-align: left; vertical-align: text-top; width: 920px;">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="CurrentOpen.rpt">
                    </Report>
