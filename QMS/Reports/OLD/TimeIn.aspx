<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="TimeIn.aspx.cs" Inherits="Reports.OLD.Reports_TimeIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script language="javascript">
        document.getElementById("timeIn").className = "active";

        $(function() {
            $("#datepicker").datepicker();
        });
    </script>
    <h3>Time In</h3>(Time recorded when truck when into sections)
