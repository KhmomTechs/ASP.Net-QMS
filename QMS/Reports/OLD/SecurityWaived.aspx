<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Reports.master" AutoEventWireup="true" CodeFile="SecurityWaived.aspx.cs" Inherits="Reports.OLD.Reports_SecurityWaived" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h3>Security check</h3>(Waived by Depot manager from Security inspection)
        ...
        <tr>
            <td style="text-align: left; vertical-align: text-top; width: 920px;">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="FailedSecurityReport.rpt">
                    </Report>
