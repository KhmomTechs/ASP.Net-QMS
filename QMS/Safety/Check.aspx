<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Safety.master" AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="Safety.Safety_Check" %>
...
<tr>
    ...
    <td style="border: 1px solid #000000; font-weight: bold; width: 8%;"><!--<asp:CheckBox ID="CheckThemFaill" runat="server" AutoPostBack="true"/> --> Fail</td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ExtinguishersCheck_1" AutoPostBack="true" Checked='<%# Eval("ExtinguishersCheck_1") == DBNull.Value ? false : Eval("ExtinguishersCheck_1") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="CheckomcCheclist" AutoPostBack="true" Checked='<%# Eval("omcCheclist") == DBNull.Value ? false : Eval("omcCheclist") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ExtingushersLabel_2" AutoPostBack="true" Checked='<%# Eval("ExtingushersLabel_2") == DBNull.Value ? false : Eval("ExtingushersLabel_2") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="CompartmentsEmpty_3" AutoPostBack="true" Checked='<%# Eval("CompartmentsEmpty_3") == DBNull.Value ? false : Eval("CompartmentsEmpty_3") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="TyreCondition_4" AutoPostBack="true" Checked='<%# Eval("TyreCondition_4") == DBNull.Value ? false : Eval("TyreCondition_4") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ExposedWires_5" AutoPostBack="true" Checked='<%# Eval("ExposedWires_5") == DBNull.Value ? false : Eval("ExposedWires_5") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="FunctionalBattery_6" AutoPostBack="true" Checked='<%# Eval("FunctionalBattery_6") == DBNull.Value ? false : Eval("FunctionalBattery_6") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="HandBrakeCondition_7" AutoPostBack="true" Checked='<%# Eval("HandBrakeCondition_7") == DBNull.Value ? false : Eval("HandBrakeCondition_7") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="BottomExhaustPipe_8" AutoPostBack="true" Checked='<%# Eval("BottomExhaustPipe_8") == DBNull.Value ? false : Eval("BottomExhaustPipe_8") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ExhaustCondition_9" AutoPostBack="true" Checked='<%# Eval("ExhaustCondition_9") == DBNull.Value ? false : Eval("ExhaustCondition_9") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="FlameArrestorFitted_10" AutoPostBack="true" Checked='<%# Eval("FlameArrestorFitted_10") == DBNull.Value ? false : Eval("FlameArrestorFitted_10") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="SelfStart_11" AutoPostBack="true" Checked='<%# Eval("SelfStart_11") == DBNull.Value ? false : Eval("SelfStart_11") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="BatteryInsulated_12" AutoPostBack="true" Checked='<%# Eval("BatteryInsulated_12") == DBNull.Value ? false : Eval("BatteryInsulated_12") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="DashboardFree_13" AutoPostBack="true" Checked='<%# Eval("DashboardFree_13") == DBNull.Value ? false : Eval("DashboardFree_13") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="Earthingplate_14" AutoPostBack="true" Checked='<%# Eval("Earthingplate_14") == DBNull.Value ? false : Eval("Earthingplate_14") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ContainersRemoved_16" AutoPostBack="true" Checked='<%# Eval("ContainersRemoved_16") == DBNull.Value ? false : Eval("ContainersRemoved_16") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ProperSealing_18" AutoPostBack="true" Checked='<%# Eval("ProperSealing_18") == DBNull.Value ? false : Eval("ProperSealing_18") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="DangerPetroleumSign_20" AutoPostBack="true" Checked='<%# Eval("DangerPetroleumSign_20") == DBNull.Value ? false : Eval("DangerPetroleumSign_20") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="OilLeaking_21" AutoPostBack="true" Checked='<%# Eval("OilLeaking_21") == DBNull.Value ? false : Eval("OilLeaking_21") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="ValveCouplingComp_22" AutoPostBack="true" Checked='<%# Eval("ValveCouplingComp_22") == DBNull.Value ? false : Eval("ValveCouplingComp_22") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="BrokenLights_23" AutoPostBack="true" Checked='<%# Eval("BrokenLights_23") == DBNull.Value ? false : Eval("BrokenLights_23") %>' runat="server"/>
    </td>
    <td>
...
<tr>
    ...
    <td>K/E/N Number</td>
    <td>
        <asp:CheckBox ID="KEN_Number_24" AutoPostBack="true" Checked='<%# Eval("KEN_Number_24") == DBNull.Value ? false : Eval("KEN_Number_24") %>' runat="server"/>
    </td>
    <td>
        <asp:CheckBox ID="CheckBox21" runat="server" AutoPostBack="true"/>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="TruckLadderSpace_25" AutoPostBack="true" Checked='<%# Eval("TruckLadderSpace_25") == DBNull.Value ? false : Eval("TruckLadderSpace_25") %>' runat="server"/>
    </td>
    <td>
        <asp:CheckBox ID="CheckBox22" runat="server" AutoPostBack="true"/>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="WheelChokesChaned_26" AutoPostBack="true" Checked='<%# Eval("WheelChokesChaned_26") == DBNull.Value ? false : Eval("WheelChokesChaned_26") %>' runat="server"/>
    </td>
    <td>
        <asp:CheckBox ID="CheckBox23" AutoPostBack="true" runat="server"/>
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="necessary_PPE" AutoPostBack="true" Checked='<%# Eval("necessary_PPE") == DBNull.Value ? false : Eval("necessary_PPE") %>' runat="server"/>
    </td>
    <td>
        <asp:CheckBox ID="CheckBox24" AutoPostBack="true" runat="server"/>
...
<%--        <tr>
             ...
             <td><asp:CheckBox ID="CheckDanger" AutoPostBack="true" Checked='<%# (Eval("CheckDanger")==DBNull.Value ? false : Eval("CheckDanger")) %>' runat="server" /></td>
        <td><asp:CheckBox ID="CheckBox25" AutoPostBack="true" runat="server" />
        ...
        <tr>
             ...
             <td><asp:CheckBox ID="ignitionSources" AutoPostBack="true" Checked='<%# (Eval("ignitionSources")==DBNull.Value ? false : Eval("ignitionSources")) %>' runat="server" /></td>
        <td><asp:CheckBox ID="CheckBox28" AutoPostBack="true" runat="server" />
        ...
        <tr>
             ...
             <td><asp:CheckBox ID="CheckBtmValves" AutoPostBack="true" Checked='<%# (Eval("CheckBtmValves")==DBNull.Value ? false : Eval("CheckBtmValves")) %>' runat="server" /></td>
        <td><asp:CheckBox ID="CheckBox27" AutoPostBack="true" runat="server" />
...
<tr>
    ...
    <td>
        <asp:CheckBox ID="CheckERInst" AutoPostBack="true" Checked='<%# Eval("CheckERInst") == DBNull.Value ? false : Eval("CheckERInst") %>' runat="server"/>
    </td>
    <td>
        <asp:CheckBox ID="CheckBox29" AutoPostBack="true" runat="server"/>
...
<asp:Panel ID="CommentPanel" Visible="false" runat="server">
    ...
    <asp:TextBox ID="ImmCorrectiveTxt" Text='<%# Bind("ImmCorrAction") %>' ValidationGroup="Comment" Width="500px" TextMode="MultiLine" runat="server"></asp:TextBox><br/>
...
<p>
    <asp:Button ID="SaveBtn" CommandName="Update" ValidationGroup="Comment" CssClass="btn" runat="server" Visible="false" Text="SAVE"/><asp:Button ID="ApproveBtn" CssClass="btn" runat="server" Text="SAFETY APPROVED" Visible="false" onclick="ApproveBtn_Click"/>&nbsp;&nbsp;<asp:Button ID="GoBack" CssClass="btn" runat="server" Text="BACK"
...
<asp:SqlDataSource ID="FuelFacsSource" runat="server"
                   ...
                   SelectCommand="SELECT * FROM PS28orders WHERE (PS28orders.ORDER_NO = @ORDER_NO)">
    <SelectParameters>
        <asp:QueryStringParameter Name="ORDER_NO" QueryStringField="order"/>
    </SelectParameters>
</asp:SqlDataSource>
