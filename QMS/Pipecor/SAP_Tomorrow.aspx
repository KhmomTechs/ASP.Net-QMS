<%@ Page Language="C#" MasterPageFile="~/Master/Pipecor.master" AutoEventWireup="true" CodeFile="SAP_Tomorrow.aspx.cs" Inherits="Pipecor.Pipecor_SAP_Tomorrow" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
<script language="javascript">
    document.getElementById("tomorrow").className = "active";
</script>
...
<asp:Panel ID="PanelExp" Height="420px" Visible="false" runat="server">
    ...
    <div class="gridBorder" style="min-height: 335px">
        ...
        <asp:GridView ID="GridExp" runat="server" Width="1000px" AllowPaging="True" DataKeyNames="SAP_Request_No"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="" Visible="false" ItemStyle-CssClass="Visibility" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility">
                    <ItemTemplate>
                        <asp:CheckBox ID="ChkReject" runat="server" Visible="false" Checked='<%# Eval("Rejected") == DBNull.Value ? false : Eval("Rejected") %>' oncheckedchanged="ChkExportReject_CheckedChanged" CssClass="Visibility" AutoPostBack="true"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ControlStyle-CssClass="Visibility" Visible="false">
                    <ItemTemplate>
                        <asp:Button ID="btnExportQueue" runat="server" CausesValidation="false" CssClass="Visibility" onclick="btnExportQueue_Click" OnClientClick="return confirm('Are you sure?');" Text="QUEUE ORDER"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ControlStyle-CssClass="Visibility" Visible="false">
                    <ItemTemplate>
...
<asp:Panel ID="PanelLoc" Height="420px" runat="server">
    <h4>LOCAL QUEUE</h4>
    <div class="gridBorder" style="min-height: 335px;">
        <asp:GridView ID="GridLocal" runat="server" Width="1000px" AllowPaging="True" DataKeyNames="SAP_Request_No"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="" Visible="false" ItemStyle-CssClass="Visibility" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility">
                    <ItemTemplate>
                        <asp:CheckBox ID="ChkReject" runat="server" Checked='<%# Eval("Rejected") == DBNull.Value ? false : Eval("Rejected") %>' oncheckedchanged="ChkLocalReject_CheckedChanged" CssClass="Visibility" Visible="false" AutoPostBack="true"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ControlStyle-CssClass="Visibility" Visible="false">
                    <ItemTemplate>
                        <asp:Button ID="btnLocalQueue" runat="server" CausesValidation="false" onclick="btnLocalQueue_Click" OnClientClick="return confirm('Are you sure?');" CssClass="Visibility" Text="QUEUE ORDER"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ControlStyle-CssClass="Visibility" Visible="false">
                    <ItemTemplate>
