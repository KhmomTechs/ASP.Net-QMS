...
namespace Pipecor
{
    public partial class Pipecor_SAP_Tomorrow : Page
    {
        ...
        {
            QueueView();
            SqlExportSource.SelectParameters["TheDate"].DefaultValue = DateTime.Today.AddDays(1).ToString();
            SqlLocalSource.SelectParameters["TheDate"].DefaultValue = DateTime.Today.AddDays(1).ToString();

            TotalExportSource.SelectParameters["TheDate"].DefaultValue = DateTime.Today.AddDays(1).ToString();
            TotalLocalSource.SelectParameters["TheDate"].DefaultValue = DateTime.Today.AddDays(1).ToString();
        }
