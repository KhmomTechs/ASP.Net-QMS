<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Display.master" AutoEventWireup="true" CodeFile="GeneralExport.aspx.cs" Inherits="Screens_Changed.GeneralExport" %>
                        ...
                        <td colspan="2" style="text-align: left; vertical-align: top;">
                            <asp:GridView ID="GridLocal" runat="server" AutoGenerateColumns="False" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="PRT" ReadOnly="true" ItemStyle-Width="50px"/>
                                    ...
                                    <asp:BoundField DataField="MSP" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="MSP"/>
                                    <asp:BoundField DataField="MSPB" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="MSPB"/>
                                    <asp:BoundField DataField="AGO" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="AGO"/>
                                    <asp:BoundField DataField="AGOB" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="AGOB"/>
                                    <asp:BoundField DataField="KERO" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="KERO"/>
                                    <asp:BoundField DataField="JET" ControlStyle-CssClass="Visibility" HeaderStyle-CssClass="Visibility" ItemStyle-CssClass="Visibility" HeaderText=""
                                                    SortExpression="JET"/>
                                </Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                               ...
                                               SelectCommand="SELECT * FROM NewQueue WHERE Type = 'Export' AND Status != 'Finished' AND Finished IS NULL AND SetDate = @TheDate Order by NewQueue.Queue_No, NewQueue.StatusTime, NewQueue.LO_NO">
                                <SelectParameters>
