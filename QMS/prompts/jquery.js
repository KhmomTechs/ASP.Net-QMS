...
(function() {
        ...
        filter: {
            ...
            ATTR: function(Y, W) {
                ...
                return T == null
                    ...
                    : X === "|=" ? Z === U || Z.substr(0, U.length + 1) === U + "-" : false
            },
    ...
    var K = document.compareDocumentPosition
        ? function(U, T) { return U.compareDocumentPosition(T) & 16 }
...
o.fn.extend({
    ...
    serializeArray: function() {
        return this.map(function() { return this.elements ? o.makeArray(this.elements) : this })
            .filter(function() {
                return this.name &&
                    !this.disabled &&
                    (this.checked ||
            ...
            if (J.readyState == 0) {
                ...
                if (!K && J && (J.readyState == 4 || X == "timeout")) {
                    ...
                    R = X == "timeout"
                        ...
                        : !o.httpSuccess(J)
                        ? "error"
                        : M.ifModified && o.httpNotModified(J, M.url) ? "notmodified" : "success";
                    if (R == "success") {
                        try {
...
o.extend({
    speed: function(G, H, F) {
        ...
        E.duration = o.fx.off
            ? 0
            : typeof E.duration === "number" ? E.duration : o.fx.speeds[E.duration] || o.fx.speeds._default;
        E.old = E.complete;
        E.complete = function() {
            if (E.queue !== false) {
                o(this).dequeue()
...
o.fx.prototype = {
    ...
    step: function(H) {
        ...
        if (H || G >= this.options.duration + this.startTime) {
            ...
            this.pos = o.easing[this.options
                .easing ||
    ...
    function(I, G) {
        ...
        o.fn[J] = function(K) {
            return this[0] == l
                ...
                : this[0] == document
                ? Math.max(document.documentElement["client" + G],
